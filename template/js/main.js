...
(function($) {
	...
	$("#preloaderclose").on('click', function(event){
    ...
    /*================================
    3. portfo masonry & filter
    ==================================*/
    $('#portfo-masonry').imagesLoaded(function() {
        // filter items on button click
        $('.portfo-filter').on('click', 'button', function() {
            var filterValue = $(this).attr('data-filter');
            $grid.isotope({ filter: filterValue });
        });
        // init Isotope
        var $grid = $('.portfo-masonry-area').isotope({
            itemSelector: '.portfo-grid',
            percentPosition: true,
            masonry: {
                // use outer width of grid-sizer for columnWidth
                columnWidth: '.portfo-grid',
            }
        });
    });
    ...
    4. Filter Active
    ==================================*/
    $('.portfo-filter button').on('click', function(event) {
    ...
    5. Magnific Popup
    ==================================*/
    $('.portfo-popup-view').magnificPopup({
        type: 'ajax',
        alignTop: true,
        overflowY: 'scroll',
        gallery: {
    ...
    */
    ...
    let referencesAjax = document.querySelector('#references-ajax');
        ...
        eachLink.addEventListener('click', (e) => {
            switch (eachLink) {
                ...
                case aboutAjax:
                    ...
                    break;
                case referencesAjax:
                    fetchPage(eachLink, 'ajaxcontent/references.html');
                    break;
                case happiAjax:
                ...
                case skillsAjax:
                    ...
                    break;
                case protofoAjax:
                    fetchPage(eachLink, 'ajaxcontent/portfolio.html');
                    break;
                case brandAjax:
    ...
    function fetchPage(link, page) {
        ...
        fetch(`${baseURL}/${page}`)
            ...
            .then(function (html) {
                ...
                setTimeout(function () {
                    document.querySelector('body').insertBefore(doc.querySelector('.ajax-content-add'), document.querySelector('.yes'));
